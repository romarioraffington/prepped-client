...
export const SubscriptionTest: React.FC = () => {
  ...
  const handleTestPurchase = async () => {
    ...
    try {
      ...
      if (firstOffering.availablePackages.length > 0) {
        ...
        console.log(
          "🔍 DEBUG: After purchase - isPremium:",
          isPremium,
          "subscriptionTier:",
          subscriptionTier,
        );
  ...
  const handleClearCache = () => {
    ...
    Alert.alert(
      "Cache Cleared",
      "Subscription cache cleared. The app will reinitialize with fresh data.",
    );
  };
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.statusText}>Error: {error || "None"}</Text>
        <Text style={styles.statusText}>
          Authenticated: {isAuthenticated ? "✅" : "❌"}
        </Text>
        <Text style={styles.statusText}>User ID: {user?.id || "None"}</Text>
        <Text style={styles.statusText}>
          Subscription: {hasActiveSubscription ? "✅" : "❌"}
        </Text>
        <Text style={styles.statusText}>Tier: {subscriptionTier}</Text>
        <Text style={styles.statusText}>
          Premium: {isPremium ? "✅" : "❌"}
        </Text>
      </View>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.statusText}>Count: {offerings?.length || 0}</Text>
      ...
      <View style={styles.section}>
        ...
        <TouchableOpacity
          style={styles.button}
          onPress={handleTestFeatureAccess}
        >
        ...
        <TouchableOpacity
          ...
          onPress={handleTestSubscriptionLifecycle}
        >
