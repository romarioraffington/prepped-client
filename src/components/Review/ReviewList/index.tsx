        ...
        {reviews.map((review, index) => {
          ...
          return (
            <View
              ...
              style={[
                styles.reviewCard,
                { paddingLeft: index === 0 ? 0 : CARD_PADDING },
              ]}
            >
              {/* Profile Section */}
              <View style={styles.profileSection}>
                <ProfileIcon
                  ...
                  onPress={() =>
                    handleAuthorPress(review.authorAttribution.profileUri)
                  }
                  letter={
                    ...
                    {publishedTime && (
                      <>
                        ...
                        <Text style={styles.reviewDate}>
                          {formatRelativeTimeDescriptive(publishedTime)}
                        </Text>
                      </>
                    )}
                  </View>
