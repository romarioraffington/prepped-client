  ...
  const subscriptionContent = (
    <View style={styles.contentContainer}>
      ...
      <Text style={styles.description}>
        👋 Tripster, save unlimited recommendations, organize trips with ease,
        and get early access to new Premium features as they launch.
      </Text>
      ...
      {hasActiveSubscription && (
        <View style={styles.planSection}>
          ...
          <View style={styles.planRow}>
            ...
            >
              {isAutoRenewEnabled ? "Renews" : "Expiring"}
            </Text>
            <Text
              style={[
                styles.planValue,
        ...
        {!hasActiveSubscription && (
          <TouchableOpacity style={styles.actionItem} onPress={handleSubscribe}>
            <View style={styles.actionContent}>
              <View>
                <Text style={[styles.actionTitle, styles.highlightText]}>
                  Subscribe ✨
                </Text>
                <Text style={styles.actionSubtitle}>
                  Subscibe for unlimited imports
                </Text>
              </View>
            </View>
            <ChevronForward />
        ...
        {hasActiveSubscription && !isAutoRenewEnabled && (
          ...
          >
            <View>
              ...
              <Text style={styles.actionSubtitle}>
                Enable auto-renew to avoid losing access
              </Text>
            </View>
            <ChevronForward />
          </TouchableOpacity>
          ...
          <TouchableOpacity style={styles.actionItem} onPress={handleToppingUp}>
            <View style={styles.actionContent}>
              <View>
                ...
                <Text style={styles.actionSubtitle}>
                  Purchase additional imports credts
                </Text>
              </View>
            </View>
            <ChevronForward />
