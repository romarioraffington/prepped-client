    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.content}>
        <View style={styles.headerContainer}>
          <TouchableOpacity activeOpacity={0.7} onPress={handleClosePress} style={styles.closeButton}>
        ...
        <View style={styles.bodyContainer}>
          <TouchableOpacity activeOpacity={0.7} style={styles.cardContainer} onPress={handleImportByShare}>
            <View style={styles.cardRow}>
              <View style={styles.cardRowLeft}>
                <Text style={styles.cardMainText}>Import by sharing{"\n"}from other apps</Text>
          ...
          <View style={styles.cardContainer}>
            <TouchableOpacity activeOpacity={0.4} style={styles.cardRow} onPress={handleImportByLink}>
              <View style={styles.cardRowLeft}>
                <Text style={styles.cardMainText}>Import by pasting {"\n"}the content link</Text>
                <View style={styles.cardCTAContainer}>
